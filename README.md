...
- Timestamp: `2022-06-22 07:48`
- Build ID: `92a0d4d0-eff5-4cc4-b0c5-3027a2e259e2`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/92a0d4d0-eff5-4cc4-b0c5-3027a2e259e2.git
$ cd 92a0d4d0-eff5-4cc4-b0c5-3027a2e259e2
```
